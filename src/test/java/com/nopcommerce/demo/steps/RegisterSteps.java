...
public class RegisterSteps {
    ...
    public void userEnterFirstname() {
        new RegisterPage().enterFirstName("Smart");
    }
    ...
    public void userSelectYear() {
        new RegisterPage().selectDateOfBirth("1", "1", "1980");
    }

    @And("User Enter email")
    public void userEnterEmail() {
        new RegisterPage().enterEmail("smarttester@gmail.com");
    }

    @And("User Enter password")
    public void userEnterPassword() {
        new RegisterPage().enterPassword("Tester123!");
    }

    @And("User Enter Confirm Password")
    public void userEnterConfirmPassword() {
        new RegisterPage().enterConfirmPassword("Tester123");
    }
